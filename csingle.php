                ...
                <div class="row">
                    <div class="col-md-12">                    
                        <div class="page-title-heading">
                            <h2 class="title">Photoshop with EAI</h2>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="author-post">
                            ...
                            <div class="author-body">
                                ...
                                <p class="desc">Before engineering, I developed and implemented CI (Continuous Improvement) management systems in companies across America in various industries to include a military finance organization. </p>
                            </div><!--/.author-info -->
                        </div><!--/.author-info -->
                                            ...
                                            <article class="comment">
                                                ...
                                                <div class="comment-detail">
                                                    <div class="comment-meta">
                                                        <p class="comment-author"><a href="#">Sid Bro</a></p> 
                                         ...
                                         <li>
                                            <article class="comment style1">
                                                ...
                                                <div class="comment-detail">
                                                    ...
                                                    <p class="comment-body">Sed ut perspiciatis unde omnis iste natus sit voluptatem laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore</p>
                                                    <a href="#" class="comment-reply">Reply</a>
                                                </div><!-- /.comment-detail -->
                                            </article><!-- /.comment -->
                                        </li>
